...
public class Ball extends Thread {
      ...
      *  the ball's location at the center of the bouncing region
      */
      ...
      *  It then checks if the ball has reached a boundary and if so 
      *  reverses direction
      */
      public void move() {
	      ...
	      //              directionX = -directionX;   //  move toward left wall
              kit.beep();
          } //if ball hits paddle
          if (locationX <= leftWall){
              directionX = + 1;   //  move toward right wall
	      //              directionX = -directionX;   //  move toward right wall
              kit.beep();
