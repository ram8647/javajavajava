...
on a {\tt JButton}.
\label{fig-clickme}\label{pg-fig-clickme}}
\end{figure}
...
\label{fig-converterclass}\label{pg-fig-converterclass}}
\end{figure}
...
\label{fig-convertscreen}
\label{pg-fig-convertscreen}}
...
\label{fig-convertscreen3}\label{pg-fig-convertscreen3}}
...
\label{fig-borderlayout}\label{pg-fig-borderlayout}}
...
\label{fig-metricgui3}\label{pg-fig-metricgui3}}
\end{figure}
...
\label{fig-convertscreen5}\label{pg-fig-convertscreen5}}
...
interface. \label{fig-acmegui}\label{pg-fig-acmegui}}
\end{figure}
%\end{figure}
...
\label{fig-nestedbox}\label{pg-fig-nestedbox}}
...
\label{fig-orderapplet}
\label{pg-fig-orderapplet}}
\end{figure}
...
\end{lstlisting}
\end{jjjlistingleft}
\jjjprogstop{{\it (continued)} The {\tt OrderApplet} class, Part II.}
\end{figure}
...
\label{fig-menuterms}\label{pg-fig-menuterms}}
\end{figure}
...
\label{fig-texteditor}\label{pg-fig-texteditor}}
\end{figure}
...
\end{lstlisting}
\end{jjjlisting}
\jjjprogstop{{\it (continued)} The {\tt SimpleTextEditor}, Part II.}
\end{figure}
...
is necessary.
\label{fig-scrollexample}
\label{pg-fig-scrollexample}}
%\end{figure}
%\end{figure}
...
\label{fig-errdialog}\label{pg-fig-errdialog}}
