...
\label{fig-riddleclass}
\label{pg-fig-riddleclass}}
\end{figure}
...
\TBT{0pc}{Java keywords.\label{tab-keywords}}
%\begin{tabular}{l}
...
\end{lstlisting}
\end{jjjlisting}
\jjjprogstop{{\tt Hello\-World\-Applet} program.
\label{fig-helloapplet}
\label{pg-fig-helloapplet}}
\end{figure}
...
The {\tt HelloWorldApplet} also contains some elements, such as the
...
\marginfig{chptr01/1f4.eps}{Running the {\tt HelloWorld.java} application
program.
\label{fig-stdout}
\label{pg-fig-stdout}}
...
\end{lstlisting}
\end{jjjlisting}
\jjjprogstop{An example of an HTML file containing an {\tt <applet>} tag.
This specification will run the Java program named {\tt 
HelloWorldApplet.class}.
\label{fig-applettag}
\label{pg-fig-applettag}}
\end{figure}
...
<applet>} tag\index{applet tag} be specified correctly, designating
...
\marginfig{chptr01/1f6.eps}{Running
{\tt HelloWorldApplet.java} applet.
\label{fig-hello}
\label{pg-fig-hello}}
