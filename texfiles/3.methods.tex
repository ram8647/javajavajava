...
\end{lstlisting}
\end{jjjlisting}
\jjjprogstop{A Swing program with a method for drawing a set of sticks.}
{fig-drawsticksprog}
\end{figure}
...
\begin{figure}[tbh]
\figaleftscaled{chptr03/drawsticks.eps}{0.70}{The DrawSticksCanvas as displayed in a
Java window.}
{fig-drawstickseps}
\end{figure}
