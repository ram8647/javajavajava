...
\label{fig-arrayalloc}
\label{pg-fig-arrayalloc}}
%\end{graphic}
%\end{figure}
...
\label{fig-initarrays}\label{pg-fig-initarrays}}
\end{figure} 
...
0       &      10.1  \\
\end{tabular}
\captionmargin{Output of the {\tt PrintArrays} program.
...
Its output is shown in Figure~9.8.
\label{fig-squares100}\label{pg-fig-squares100}}
\end{figure}
\marginpar{
\vspace*{-10pc}
\small
...
\label{fig-letfrequml}
\label{pg-fig-letfrequml}}
...
AnalyzeFreq}.
\label{fig-anafrequml}
\label{pg-fig-anafrequml}}
...
\label{sec-sort}\label{pg-sec-sort}
...
\label{fig-bubblemeth}\label{pg-fig-bubblemeth}}
\end{figure}
...
\label{fig-arrayparam}\label{pg-fig-arrayparam}}
\end{figure}
...
\label{fig-search}\label{pg-fig-search}}
\end{figure}
...
\label{fig-testsearch}\label{pg-fig-testsearch}}
\end{figure}
...
\label{fig-rainfall}\label{pg-fig-rainfall}}
\end{figure}
...
\label{fig-twodrow}\label{pg-fig-twodrow}}
\end{figure}
...
\label{fig-rainfallclass}\label{pg-fig-rainfallclass}}
\end{figure}
...
\label{fig-threedarray}\label{pg-fig-threedarray}}
\end{figure}
...
\label{sec-vectors}\label{pg-sec-vectors}
\WWWjava
...
\label{fig-vectordemo}\label{pg-fig-vectordemo}}
\end{figure}
...
\label{fig-computergame}
\label{pg-fig-computergame}}
...
\label{fig-gamesource}
\label{pg-fig-gamesource}}
\end{figure}
...
\label{fig-GUIplayble}
\label{pg-fig-GUIplayable}}
...
\label{fig-slidingpuzzle}
\label{pg-fig-slidingpuzzle}}
...
\label{fig-puzzlecode}
\label{pg-fig-puzzlecode}}
\end{figure}
...
\label{fig-slidingGUI}
\label{pg-fig-slidingGUI}}
