...
\label{fig-converter}\label{pg-fig-converter}}
\end{figure}
...
\end{lstlisting}
\end{jjjlistingleft}
\jjjprogstop{The use of a local class as an {\tt ActionListener} adapter.
\label{fig-converterframe}\label{pg-fig-converterframe}}\end{figure}
