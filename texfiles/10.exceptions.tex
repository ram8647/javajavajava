...
\label{fig-intavg1}\label{pg-fig-intavg1}}\end{figure}
...
\label{fig-trystmt}\label{pg-fig-trystmt}}
\end{figure}
...
\label{fig-dynamic}\label{pg-fig-dynamic}}
\end{figure}
...
\label{fig-myclass}\label{pg-fig-myclass}}\end{figure}
...
\label{fig-methodstack}
\label{pg-fig-methodstack}}
\end{figure}
...
\label{fig-intfieldprog}\label{pg-fig-intfieldprog}}
\end{figure}
...
NumberFormatException}. The applet will display an error message in a
{\tt JOptionPane} (a dialog window).
\label{fig-numformat}
\label{pg-fig-numformat}}
\end{figure}
...
\label{fig-arrayfixscreen}\label{pg-fig-arrayfixscreen}}
\end{figure}
...
\label{fig-arraybound}\label{pg-fig-arraybound}}
\end{figure}
...
\label{fig-arraybound2}\label{pg-fig-arraybound2}}
\end{figure}
...
should be entered.
\label{fig-intfielduml}
\label{pg-fig-intfielduml}}
...
\label{fig-intfield2}\label{pg-fig-intfield2}}\end{figure}
...
\label{fig-intbound}\label{pg-fig-intbound}}\end{figure}
...
\label{fig-errmsg2}\label{pg-fig-errmsg2}}
\end{figure}
